...
public class ParentActivity extends Activity {
    ...
    {
    	Log.i("ParentActivity", "populate2");
    }
    ...
    private Handler handler2 = new Handler() {
	    ...
	    {
	    	Log.i("ParentActivity", "handler2: handlerMessage");
	        ...
	        switch(msg.what){
		        case 0:
		            ...
		            populate2(ParentActivity.this,jArray);
		            break;
		        case 1:
    ...
    class SearchThread extends Thread {
       ...
       /* public SearchThread(String tmp) {
        ...
        public void run() {       
        	...
        	try
        	{
        		...
        		if(tmp.equals("-1"))
        		{
        			tmp=getString(R.string.json_url);
        			Log.i("ParentActivity", "SearchThread: run: tmp->"+tmp);
        		}
       ...
       private Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg)
            {
            	Log.i("SearchThread", "handler:handleMessage");
                //displaySearchResults();
            	/*
