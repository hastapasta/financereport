...
public class ParentActivity2 extends ListActivity {
	//TableLayout tl;
	ListView lv;
	String strType;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.settings:
            	...
            	Intent intent = new Intent(ParentActivity2.this, SettingsActivity.class);
                ...
                private Handler handler2 = new Handler() {
                    ...
                    public void handleMessage(Message msg)
                    {
                        ...
                        case 0:
                               /*Refresh UI*/
                               //Log.i("blap","blap");
                               //populate2(ParentActivity2.this,tl,ParentActivity2.this.fieldsRow1,ParentActivity2.this.fieldsRow2,jArray);
                        		populate2(ParentActivity2.this,lv,jArray);
                               break;
                        case 1:
                        	alertDialog = new AlertDialog.Builder(ParentActivity2.this).create();
                            alertDialog.setTitle("Alert");
    ...
    class SearchThread extends Thread {
       ...
       /* public SearchThread(String tmp) {
        ...
        public void run() {       
        	...
        	try
        	{
        		SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ParentActivity2.this);
        		...
        		//ParentActivity2.this.jArray = MySQLConnect.connect(tmp + "pebymarketcap.php",strType);
        		ParentActivity2.this.jArray = MySQLConnect.connect(tmp + strActivityPHP,ParentActivity2.this.pairs);
        	...
        	catch (CustomConnectionException cce)
        	{
        		 ...
        		 */
        		ParentActivity2.this.strErrorMessage = cce.getMessage();
