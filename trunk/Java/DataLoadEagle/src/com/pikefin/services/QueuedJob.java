...
public class QueuedJob implements Comparable<QueuedJob> {
  ...
  public int compareTo(QueuedJob o) {
    if(this.priority > o.priority) {
      ...
      try {
        Date d1 = PikefinUtil.formatter
            .parse(this.queuedInTime.getTime().toString());
        Date d2 = PikefinUtil.formatter
            .parse(o.queuedInTime.getTime().toString());
        calFirst.setTime(d1);
        ...
        ApplicationSetting.getInstance().getStdoutwriter()
          .writeln("Issue parsing time.",Logs.WARN,"QJ1.00");
        return 0;
      }
    }
  }
