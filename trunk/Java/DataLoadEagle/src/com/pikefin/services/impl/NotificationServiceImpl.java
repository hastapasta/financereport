...
@Transactional(propagation=Propagation.REQUIRES_NEW)
  public String tweet(String strTweet,String userName, String password,
      String authentication1, String authentication2, String authentication3,
      String authentication4) throws GenericException{
    ApplicationSetting.getInstance().getStdoutwriter()
    .writeln("Start sending the tweet messages. Current tweet message is -"
        +strTweet, Logs.STATUS1,"NS20");
    ...
    try	{
      ...
      if (strTweet.length() > 140) {
        ...
        ApplicationSetting.getInstance().getStdoutwriter()
          .writeln("Tweet longer than 140 characters; tweet truncated.",
              Logs.WARN,"NS21");
        ApplicationSetting.getInstance().getStdoutwriter()
          .writeln(strTweet, Logs.WARN,"NS22");
      ...
      ApplicationSetting.getInstance().getStdoutwriter()
        .writeln("Problem sending tweet",Logs.ERROR,"NS25");
