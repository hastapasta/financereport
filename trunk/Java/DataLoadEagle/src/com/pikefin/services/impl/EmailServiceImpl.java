...
public class EmailServiceImpl implements EmailService {
  ...
  @Override
  public void generateBulkEmail(List<HashMap<String,String>> listAlerts,
      String emailAddress) throws GenericException {

    String emailMessage = "";

    emailMessage = notificationService.generateVelocity(listAlerts,"alertList",
        ApplicationSetting.getInstance().getBulkEmailTemplate());

    String emailSubject = ApplicationSetting.getInstance()
        .getEmailSubjectText() + " Bulk Email Notification";
  ...
  public void sendHtmlEmail(String emailAddress, String emailMessage,
    ...
    try {
      ...
      email.setAuthentication(
          ApplicationSetting.getInstance().getEmailUser(),
          ApplicationSetting.getInstance().getEmailPassword());
      ...
      ApplicationSetting.getInstance().getStdoutwriter()
        .writeln("Problem sending html email."+ ee,
            Logs.ERROR, "ESI20");
    }
