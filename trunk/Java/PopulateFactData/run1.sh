...
CURRENTDIR=/home/ollie/workspace/MultiTest
...
#java -classpath $CLASSPATH MultiTest $1 $2  2>$CURRENTDIR/error 
#java -classpath $CLASSPATH MultiTest linktest 'http://localhost:8080/JSPDataSource/mysqldatasource2eh2.jsp?entitygroupid=5&metricid=1&timeframe=year&order=DESC'
java -classpath $CLASSPATH MultiTest yahootest 'http://localhost:8080/JSPDataSource/mysqldatasource2eh2.jsp?entitygroupid=5&metricid=1&timeframe=year&order=DESC'
