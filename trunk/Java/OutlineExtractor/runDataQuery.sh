...
CLASSPATH=/home/ollie/workspace/eis:$ESS_ES_HOME/lib/ess_japi.jar
echo $CLASSPATH
...
#REM pause  
$JAVA_HOME/bin/java -classpath $CLASSPATH DataQuery $USER $PASSWORD $DOMAIN $EES_SERVER $ORB $PORT $OLAP_SERVER $APP_NAME $CUBE_NAME $ROOT_MEMBER_NAME
