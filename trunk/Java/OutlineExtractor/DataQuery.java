...
public class DataQuery
{
	...
	public static void newmain(String[] args)
	{
		...
		params[1] = "madmax1.";
		params[2] = "oracleepm";
		params[3] = "http://oracleepm:13080/aps/JAPI";
		Connect.connectfunc(params);
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			cv = dom.openCubeView("Data Query Example", s_olapSvrName, s_appName,s_cubeName);
	...
	static void acceptArgsOld(String[] args) throws EssException
	{
		if (args.length >= 10) 
		{
			s_userName = args[0];
