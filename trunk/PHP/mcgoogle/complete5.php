    ...
    <script type="text/javascript">
        ...
        function loadChart() {
            ...
            var metric1 = document.getElementById('metric-1').value;
         	...
         	http://www.pikefin.com/devjsp/JSPDataSource/mysqldatasource6.jsp?taskid=22
 			
           
            //var query = new google.visualization.Query('http://localhost/PHP/ajaxsample/echodatasource.php');
         		var query = new google.visualization.Query('http://www.pikefin.com/devjsp/JSPDataSource/mysqldatasource6.jsp?taskid=22');
            //alert(str);
