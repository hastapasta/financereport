...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadChart() {
            ...
            var query = new google.visualization.Query('http://www.pikefin.com/devjsp/JSPEssbase2/essbasedatasource.jsp');
            //alert(str);
            ...
            query.send(
           	function(res)
           	{
                ...
                else
                {
                    ...
                    {
		     			//alert('here 2.1');
                    	 bar_chart = new google.visualization.BarChart(document.getElementById('chart-div'));
                    	 //alert('here 2.5');
                   	}
		   			//alert('here 2.7');
