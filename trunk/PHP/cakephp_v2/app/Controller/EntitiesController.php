...
=> array('UsersAmenities')));*/
	...
	function view($id = null) {
		...
		if (!$id) {
			$this->Session->setFlash(__('Invalid entity'));
	...
	function add() {
		if (!empty($this->request->data)) {
			...
			if ($this->Entity->save($this->request->data)) {
				$this->Session->setFlash(__('The entity has been saved'),'default',array('class'=>'green_message'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The entity cound not be saved. Please see below for additional information.'));
			}
		}
	}
	...
	function edit($id = null) {
		...
		if (!empty($this->request->data)) {
			if ($this->Entity->saveAll($this->request->data['Entity'])) {
				$this->Session->setFlash(__('The Entities has been saved'),'default',array('class'=>'green_message'));
				$this->Session->delete('Record');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The Entities cound not be saved. Please see below for additional information.'));
			}
		}
		if (!empty($record)) {
			$this->request->data = $this->toMulti($this->Entity->find('all',array('conditions'=>array('Entity.id'=>$record))));
		}
		if (empty($this->request->data)) {
			$this->Session->setFlash(__('Invalid Entities'));
			$this->redirect(array('action' => 'index'));
		}	
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Invalid id for entity'));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Entity->delete($id)) {
			$this->Session->setFlash(__('Entity deleted'),'default',array('class'=>'green_message'));
			$this->redirect(array('action'=>'index'));
		}
	...
	function split(){
		...
		$ratio = $this->request->params['url']['ratio'];
		$entity_id = $this->request->params['url']['entity_id'];
		$datecutoff = $this->request->params['url']['datecutoff'];
