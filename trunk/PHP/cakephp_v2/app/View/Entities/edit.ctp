...
for($i = 0; $i < sizeof($this->request->data['Entity']); $i++){
?>
<fieldset><legend><?php echo __('Edit Entity'); ?></legend> <?php
...
echo "<button type=\"button\" id=\"split".$this->request->data['Entity'][$i]['id']."\" name=\"".$this->request->data['Entity'][$i]['id']."\">Split</button>";
?>
<script>
	$(function() {
	<?php echo "$( \"#split".$this->request->data['Entity'][$i]['id']."\" )" ?>
			.button()
			.click(function() {
