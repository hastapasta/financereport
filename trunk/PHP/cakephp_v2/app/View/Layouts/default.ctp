<?php
include_once (dirname(ROOT) . DS . "PHP" . DS . "site" . DS . "includes" . DS . "sitecommon.php");
//echo "here 1";
/**
 *
...
//echo $this->Js->link(array('jquery-1.5.1.js'));
//echo $this->Js->link(array('jquery-ui-1.8.12.custom.min.js'));
...
<div id="header">
	...
	<!--	<div id="logo">
			<?php //echo $this->Html->image('logo.jpg',array('url'=>array('controller'=>'alerts','action'=>'index'))); ?>
		</div> -->
...
<div id='menus'>
	...
	if( $this->request->params['action'] != 'login')
	 echo $this->element('tabs', array('currentpage'=> $this->request->params['controller']))
    ?>
</div>
<div id="content"><?php
