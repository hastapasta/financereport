...
if (sizeof($this->request->params['pass']) > 0)
	$task = $this->request->params['pass'][0];
//debug($this->request->params['pass'],true);
//debug($this->Html->url(),true);
...
<script type="text/javascript">
        ...
        function submitForm() {
			...
			echo substr($this->request->here,0,strpos($this->request->here,"chartb")+6);
			//echo $this->Html->url();
			echo "\"+url);\n";
