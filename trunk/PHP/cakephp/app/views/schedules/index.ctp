		...
		<tr>
			<td style="width: 10%;">
				<table class="searchTable" cellspacing="0"> <?php 
				  echo $this->Form->create( 'Schedule',
					...
					<tr>
						<td><?php 
						  echo $this->Form->end(__('Refresh List', true)); ?>
						</td>
					</tr>
				</table>
			</td>
			<td>
				<div class="alerts index" style='width: 95%'> <?php 
					echo $form->create('Schedule',array('controller'=>'schedules',
					    'action'=>'action_process','class'=>'recordForm'));
					echo $form->hidden('Schedule.action_value',
            	...
            	if ($i++ % 2 == 0) {
		            ...
		            $j++;
		            echo $form->checkbox('Schedule'.$j, array('label'=>false, 
		                'type'=>'checkbox', 
