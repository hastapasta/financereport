...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'entity_groups', 'action' => 'view', $entityGroup['id'])); ?>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'fact_data', 'action' => 'view', $factDatum['id'])); ?>
