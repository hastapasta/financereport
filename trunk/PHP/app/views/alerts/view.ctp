...
<script type="text/javascript" src="http://www.google.com/jsapi"></script>
    <script type="text/javascript">
        ...
        function sendAndDraw() {
            ...
            chart.innerHTML="<img src=\"/PHP/site/images/spinner3-bluey.gif\" />";

            var chart2 = document.getElementById('barchart-div');
            chart2.innerHTML="<img src=\"/PHP/site/images/spinner3-bluey.gif\" />";

            var chart3 = document.getElementById('table-div');
            chart3.innerHTML="<img src=\"/PHP/site/images/spinner3-bluey.gif\" />";
            ...
            var options3 = {};
           	...
           	<?php 
           		echo "dataSourceUrl1 = jsp_root_path + '/mysqldatasource1.jsp?entityid=".$alert['Alert']['entity_id']."&metricid=".$alert['Schedule']['Task']['metric_id']."&begindate=2011-01-01';\n";
