...
<?php if($group == 1): ?>
	...
	<li><?php echo $this->Html->link(__('Chart', true), array('controller' => 'users','action' => 'chart')); ?></li>
	<?php endif; ?>
	<?php if($group == 2): ?>
	...
	<li><?php echo $this->Html->link(__('Change Password', true), array('controller' => 'users', 'action' => 'change_password')); ?>
	</li>
	<?php endif; ?>
</ul>
</div>
