<div class="tasks view">
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Use Group For Reading'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $task['Task']['use_group_for_reading']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Eps Est Priority'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Metric'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $task['Metric']['name'];?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Jobs'); ?></dt>
