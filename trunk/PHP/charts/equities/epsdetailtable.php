...
elseif (isset ($_GET['t']))
	...
	die("e (entityid) or t (ticker) url parameter is required. Terminating.");
...
<script>
	...
	$(function(){
		...
		<?php  	
	      /* If $ticker is set then url value (either entity or ticker) was passed in. */
	      //echo "//ticker: ".$ticker."\n";
			if (!empty($ticker)) {
				echo "google.setOnLoadCallback(function() { sendAndDraw() });\n";
			}
   ...
   function genericClickHandler(localTableChart,localQueryWrapper) {
    ...
    function sendAndDraw() {
      ...
      options['width'] = 800;
     	...
     	echo "queryString1='?ticker=".$ticker."&debug=false&groupby=false';\n";
...
<BR>
<div style="display:none;" > <!-- temp div to hide this for now -->
Time Frame:&nbsp;&nbsp;
...
<input type="button" style="display:none;color: #000000;background-color: #FFFFFF" value="Display Table"	onclick="sendAndDraw();return false;"> <br />
<br />
</div><!-- pf-form -->
...
<br>
<input type="button" style="display: none;float: left;clear: both;color: #000000;background-color: #FFFFFF" value="Generate URL"
	onclick="generateURL()"> <br />
</div> <!--  pf-body -->
