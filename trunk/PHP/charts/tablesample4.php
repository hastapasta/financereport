...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadChart() {
            ...
            chart.innertHTML="<img src='http://www.google.com/ig/images/spinner.gif' />";
        	
         	//alert('here 1');
            var timeeventid = document.getElementById('begindate').value;
            var timeeventid = document.getElementById('enddate').value;
            ...
            <?php 
            echo "var queryurl = '".db_utility::$datasourceurl."mysqldatasource.jsp?begindate=' + begindate;";
            ?>
...
<body>
    ...
    <div class="chart-options">
       <BR><BR>
        Begin Date:
	    <input type="text" name="begindate" id="begindate" size="20" maxlength="40">
	    End Date:
	    <input type="text" name="enddate" id="enddate" size="20" maxlength="40">
