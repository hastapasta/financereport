    ...
    <script type="text/javascript">
       ...
       /* function init() {
        ...
        function loadChart() {
            ...
            var query = new google.visualization.Query('http://localhost:8080/JSPDataSource/mysqldatasource15.jsp?entityid=1&begindate=2011-02-01');
            ...
            query.send(
           	function(res)
           	{
                ...
                else
                {
                    ...
                    {
		     			//alert('here 2.1');
                    	 line_chart = new google.visualization.AnnotatedTimeLine(document.getElementById('chart-div'));
                    	 //alert('here 2.5');
                   	}
		   			//alert('here 2.7');
