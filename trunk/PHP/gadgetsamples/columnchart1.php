...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadChart() {
            ...
            //var query = new google.visualization.Query('http://www.pikefin.com/phpdev/gadgetsamples/echodatasource.php');
            var query = new google.visualization.Query('http://localhost/PHP/gadgetsamples/echodatasource.php');
            //alert(str);
