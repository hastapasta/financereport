...
public class PopulateSpreadsheet {
	...
	public static String generateVelocity(Object input1/*ArrayList<HashMap<String, String>> hm*/, String strListName, String strTemplate) {
	...
	public static String createGoogleJSON(ArrayList<String[]> arrayListCols, ArrayList<String[]> arrayListRows,String strReqId,boolean bEmptyZeros) {
		 ...
		 * OFP 7/22/2012 - Can't remember why empty string is preferrable to a zero, but I believe it means these entries will
		 * then be excluded from the chart.
		 * 
