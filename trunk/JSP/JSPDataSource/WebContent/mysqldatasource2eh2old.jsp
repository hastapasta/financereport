...
if (strTimeFrame != null) {
	...
	if (strTimeFrame.toUpperCase().equals("HOUR"))	{
		...
		/*
		* We're going to go with Monday as the beginning of the week
		* so that we have prettier data for main/index.php market snapshots.
		*/
	...
	String temp = calBegin.getTime().toString();
	//out.println(temp);
