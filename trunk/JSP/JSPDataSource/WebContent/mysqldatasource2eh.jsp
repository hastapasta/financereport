...
This is an attempt to enhance the performance of mysqldatasource2.jsp. We're going to remove the query joins
and join the data in java.
...
catch (SQLException sqle)
{
	...
	out.println(PopulateSpreadsheet.createGoogleError(strReqId,"sql_exception",sqle.getMessage(),"PF ERROR CODE 2eh-1"));
	bException = true;
}
finally
{
