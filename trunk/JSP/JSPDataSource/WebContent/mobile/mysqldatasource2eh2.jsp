...
if (strType.toUpperCase().equals("WEAKER"))
	Collections.sort(arrayListRows,comp);
else
	Collections.sort(arrayListRows,comp2);


/* Yes there is an ArrayList.subList() function but that returns a List object
and I was having trouble with casting so I said screw it and wrote my own.*/
arrayListRows = PopulateSpreadsheet.limitRows(arrayListRows,strRows); 
...
out.println(PopulateSpreadsheet.createJSONFromArrayList(arrayListCols,arrayListRows));
